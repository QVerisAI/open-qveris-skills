---
name: qveris-etf-flow-monitor
description: Track ETF inflows, outflows, holdings, price action, and sector exposure for allocation signals. Use when an agent needs QVeris-powered finance research, live market data, filings/news evidence, cost-aware tool calls, or source-backed investment analysis for this workflow.
---
