...
```text
Use $qveris-tradermonty-trading-skills as a Markdown risk/regime monitor to review the current US market regime. Use only QVeris finance evidence. Separate primary evidence from VIX/rates/liquid-ETF proxies, lower confidence when index, breadth, or macro evidence is missing, put qveris_trace in an appendix, and do not give trading, rebalancing, or portfolio action instructions.
```
