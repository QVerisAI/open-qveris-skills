...
node qveris-portfolio-risk-monitor/scripts/run.mjs --live --holdings AAPL:25,NVDA:25,MSFT:20,TSLA:15,CASH:15 --benchmark SPY --window-days 30 --max-paid-calls 5 --max-credits 100 --output qveris-portfolio-risk-monitor/artifacts/live-smoke.md --trace qveris-portfolio-risk-monitor/artifacts/live-smoke-trace.json
```
