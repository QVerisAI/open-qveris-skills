---
name: qveris-dividend-safety-check
description: Evaluate dividend coverage, cash flow, payout ratio, debt, maturity wall, and cut risk. Use when an agent needs QVeris-powered finance research, live market data, filings/news evidence, cost-aware tool calls, or source-backed investment analysis for this workflow.
---
