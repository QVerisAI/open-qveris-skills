---
name: qveris-fed-rate-watch
description: Track Fed speeches, rate expectations, yield moves, inflation data, and market reaction for rate-sensitive assets. Use when an agent needs QVeris-powered finance research, live market data, filings/news evidence, cost-aware tool calls, or source-backed investment analysis for this workflow.
---
