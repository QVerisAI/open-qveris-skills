---
name: qveris-china-policy-radar
description: Track China policy, A-share/HK sectors, regulatory changes, macro data, and company-level readthroughs. Use when an agent needs QVeris-powered finance research, live market data, filings/news evidence, cost-aware tool calls, or source-backed investment analysis for this workflow.
---
