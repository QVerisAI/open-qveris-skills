---
name: qveris-fx-carry-risk-brief
description: Analyze FX carry, rate differentials, volatility, central-bank events, and cross-asset risk. Use when an agent needs QVeris-powered finance research, live market data, filings/news evidence, cost-aware tool calls, or source-backed investment analysis for this workflow.
---
