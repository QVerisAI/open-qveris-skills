---
name: qveris-macro-daily-brief
description: Summarize macro data, rates, FX, commodities, equity index moves, and cross-asset risks for a daily market note. Use when an agent needs QVeris-powered finance research, live market data, filings/news evidence, cost-aware tool calls, or source-backed investment analysis for this workflow.
---
