...
| `qveris_finance.fundamentals_cf` | CF fields can be cross-period or semantically inconsistent with IS | None | Exclude from aligned valuation tables and mark `statement_semantic_mismatch`. |
