---
name: qveris-customer-exposure-map
description: Map customer, supplier, revenue exposure, concentration, contract news, and filing evidence. Use when an agent needs QVeris-powered finance research, live market data, filings/news evidence, cost-aware tool calls, or source-backed investment analysis for this workflow.
---

# Customer exposure map
