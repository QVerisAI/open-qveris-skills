...
description: Run a multi-lens investment committee workflow that compares quality, value, growth, sentiment, technical, macro, and risk evidence through QVeris. Use when an agent needs QVeris-powered finance research, live market data, filings/news evidence, cost-aware tool calls, or source-backed investment analysis for this workflow.
---
