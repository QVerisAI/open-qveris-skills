---
name: qveris-scenario-sensitivity-builder
description: Build bull, base, and bear-case sensitivities from revenue, margin, valuation, rates, and catalyst assumptions. Use when an agent needs QVeris-powered finance research, live market data, filings/news evidence, cost-aware tool calls, or source-backed investment analysis for this workflow.
---

# Scenario sensitivity builder
