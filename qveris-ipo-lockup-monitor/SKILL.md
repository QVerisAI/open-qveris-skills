---
name: qveris-ipo-lockup-monitor
description: Track IPO lockup expirations, float changes, insider sales, secondary offerings, and price pressure. Use when an agent needs QVeris-powered finance research, live market data, filings/news evidence, cost-aware tool calls, or source-backed investment analysis for this workflow.
---
