...
Use this file when the market determines which public-document path matters. It routes the audited Web lane only. Quotes, bars, statements, ratios, ownership, structured events, and listed-security identity must still come from accepted QVeris finance CAP evidence.
