...
- **QVeris third-party finance beta skills**:
  ...
  - `qveris-market-research/`: CAP-native market-research workflow for evidence-backed company, peer, fundamental, event, and valuation-context notes with auditable claims.
  - `qveris-serenity-supply-chain-research/`: CAP-native adaptation of `muxuuu/serenity-skill` for supply-chain bottleneck research, evidence-bound scoring, and comparable candidate reviews without investment advice.
...
cp -a qveris-market-research ~/.codex/skills/
cp -a qveris-serenity-supply-chain-research ~/.codex/skills/
```
...
Use qveris-market-research to build an evidence-backed company and peer research note for AAPL.
Use qveris-serenity-supply-chain-research to review supply-chain bottlenecks and comparable suppliers for 600519.SH.
```
