---
name: qveris-valuation-comps-builder
description: Build peer comps, multiples, growth, margin, balance-sheet, and catalyst context for valuation. Use when an agent needs QVeris-powered finance research, live market data, filings/news evidence, cost-aware tool calls, or source-backed investment analysis for this workflow.
---

# Valuation comps builder
