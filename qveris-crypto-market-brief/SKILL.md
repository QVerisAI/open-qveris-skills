---
name: qveris-crypto-market-brief
description: Track crypto price action, flows, funding, macro linkage, news, and risk events for a market note. Use when an agent needs QVeris-powered finance research, live market data, filings/news evidence, cost-aware tool calls, or source-backed investment analysis for this workflow.
---
