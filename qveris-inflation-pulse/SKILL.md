---
name: qveris-inflation-pulse
description: Monitor CPI, PPI, wage, commodity, rent, and breakeven signals that can shift inflation-sensitive trades. Use when an agent needs QVeris-powered finance research, live market data, filings/news evidence, cost-aware tool calls, or source-backed investment analysis for this workflow.
---
