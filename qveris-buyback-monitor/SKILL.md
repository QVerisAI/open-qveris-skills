---
name: qveris-buyback-monitor
description: Track buyback authorizations, actual repurchases, cash flow support, dilution, and price reaction. Use when an agent needs QVeris-powered finance research, live market data, filings/news evidence, cost-aware tool calls, or source-backed investment analysis for this workflow.
---
