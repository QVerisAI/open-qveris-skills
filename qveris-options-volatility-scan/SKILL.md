---
name: qveris-options-volatility-scan
description: Scan implied volatility, skew, volume, open interest, and event risk for options-driven signals. Use when an agent needs QVeris-powered finance research, live market data, filings/news evidence, cost-aware tool calls, or source-backed investment analysis for this workflow.
---
